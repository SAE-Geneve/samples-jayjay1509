...
void DepthTesting::Begin()
{
  ...
  //Load shaders
  auto vertexContent = LoadFile("data/shaders/hello_depth/depth.vert");
  ...
  auto fragmentContent = LoadFile("data/shaders/hello_depth/depth.frag");
  ...
  fragmentContent = LoadFile("data/shaders/hello_depth/outline.frag");
  ptr = fragmentContent.data();
...
void DepthTesting::OnEvent(const SDL_Event& event,const float dt)
{
  // Get keyboard state
