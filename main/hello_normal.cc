...
void NormalMap::Begin()
{
  ...
  //Main program(s)
  shader_ = new Shader("data/shaders/hello_normal/normal_map.vert", "data/shaders/hello_normal/normal_map.frag");
  light_shader_ =  new Shader("data/shaders/hello_light/light.vert", "data/shaders/hello_light/light.frag");
...
void NormalMap::OnEvent(const SDL_Event& event,const float dt)
{
  // Get keyboard state
