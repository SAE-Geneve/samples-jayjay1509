...
namespace gpr5300
{
    ...
    void FaceCulling::Begin()
    {
        ...
        shader_ = new Shader("data/shaders/blending/blending.vert","data/shaders/blending/blending.frag");
    ...
    void FaceCulling::OnEvent(const SDL_Event& event,const float dt)
    {
      // Get keyboard state
